...
const colTitle = "text-xs font-semibold uppercase tracking-[0.15em] text-stone-500";
const linkClass = "text-sm text-stone-600 transition hover:text-teal-700";
    ...
    <footer className="mt-auto border-t border-stone-200 bg-white">
      <div className="market-container py-14">
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
          <div>
            <p className="text-lg font-semibold tracking-tight text-stone-900">BTB Market</p>
